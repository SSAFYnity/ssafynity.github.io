...
const sections = [
  {
    ...
    items: [
      ...
      '후원·제휴 문의 및 협업 진행',
      '공식 홈페이지 및 블로그 운영',
      '공식 홈페이지 및 블로그의 이용 현황 분석, 콘텐츠 및 서비스 개선',
      '법적 의무 이행 및 분쟁 대응',
    ],
    note:
  ...
  },
  {
    ...
    groups: [
      ...
      {
        title: '홈페이지 및 블로그 이용 분석',
        items: ['쿠키', '접속 일시', '방문 페이지', '유입 경로', '브라우저 및 기기 정보', '페이지 내 이용 기록'],
      },
    ],
    note:
  ...
  },
  {
    ...
    items: ['Google Forms: 신청서 접수', 'Gmail 등 이메일 서비스: 문의 및 운영 연락', 'GitHub Pages: 공식 홈페이지 및 블로그 배포 운영', 'Google Analytics: 공식 홈페이지 및 블로그 이용 통계 분석'],
    note:
      '동문회는 위 서비스 이용 과정에서 개인정보 보호 관련 사항을 점검하며, 운영 방식이 변경되는 경우 본 방침을 통하여 안내합니다. 또한 동문회는 공식 홈페이지 및 블로그의 이용 현황을 분석하고, 콘텐츠 구성 및 서비스 개선에 활용하기 위하여 Google Analytics를 사용할 수 있습니다. 이 과정에서 쿠키, 접속 일시, 방문 페이지, 유입 경로, 브라우저 및 기기 정보, 페이지 내 이용 기록과 같은 정보가 수집·처리될 수 있으며, 동문회는 이를 개인을 직접 식별하기 위한 목적으로 사용하지 않습니다. 이용자는 브라우저 설정을 통해 쿠키 저장을 거부하거나 제한할 수 있으며, 이에 따라 일부 통계 기능이 정상적으로 반영되지 않을 수 있습니다.',
  },
  {
